...
public class TopicosController {
	...
	public Page<TopicoDTO> lista(@RequestParam(required = false) String nomeCurso, 
		...
		//Exemplo de requisição para Pageable como parâmetro do método
		//http://localhost:8080/topicos?page=0&size=10&sort=id,asc&sort=dataCriacao,desc
		
//		@PageableDefault(sort = "id", direction = Direction.ASC)
//		Com este comando é possível setar valores padrões para a consulta
		

		//Forma manual de utilizar a classe
//		Pageable paginacao = PageRequest.of(pagina, qtd, Direction.ASC, ordenacao);
	...
	@PostMapping
	@Transactional
	// O cacheEvict informa ao spring quando um determinado cache deve ser inválidado,
	// com o parâmetro value = listaDeTopicos é informado qual o cache que ele deve inválidar,
	// o parâmetro allEntries, informa se é pra inválidar todos os registros deste cache
